<template>
	<u-navbar id="navBar" :is-back="false" :border-bottom="borderBottom" :background="background">
		<view class="slot-wrap">
			<view class="iconfont icon-fanhui back" v-if="showBack" @click="back"></view>
			<view class="iconfont icon-shouye3" v-else @click="back"></view>
...
export default {
	...
	mounted() {
		...
		if(firstPage.route == 'pages/detail/main'){
			this.showBack = false
		}	
	...
	methods: {
		back() {
			...
			if (beforePage.route == 'pages/detail/main') {
