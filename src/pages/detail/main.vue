<template>
	<view>
		<view class="detail u-skeleton">
			...
			<view v-if="isShow">
				...
				<view class="detail--nav" v-if="navShow" :style="{ top: topHeight }">
					...
					<view class="detail--nav--item" @click="jumpEvaluate">
						...
						<view :class="{ 'detail--nav--item--active': viewBox == 'box2' || evaluateShow == true }">
						</view>
					</view>
					...
					<view class="detail--nav--item" @click="jumpRecommend">
						...
						<view :class="{ 'detail--nav--item--active': viewBox == 'box4' || recommendShow == true }">
						</view>
					</view>
				</view>

				<!-- 滚动的大盒子 -->
				<scroll-view class="detail--warp" scroll-y @scroll="scrollChange" :scroll-into-view="viewBox"
					...
					<view class="detail--warp--goods" id="box1">
						<view class="detail--warp--goods--swiper u-skeleton-rect">
							...
							<swiper :autoplay="false" :interval="3000" :duration="1000" :circular="true"
								@change="changeSwiper">
								<block v-for="(item, index) in goodsShowList" :key="index">
									<swiper-item>
										<video :src="item.goodsFileUrl | urlFilter" controls
											v-if="item.goodsFileSort!==null?item.goodsFileSort.indexOf('video')>0:false"></video>
						...
						<view class="detail--warp--goods--explain">
							<!-- 秒杀商品 -->
							<view class="goodsSeckill" v-if="goodsData.goodsType == '26'">
								<view class="simg">
									<image src="@/static/index/miaosha.png" mode="" style="width: 100%;height: 100%;">
									</image>
								</view>
								<view class="sprice">
									<view class="left">
										<view class="ntop">
											{{ '￥' + toFix(goodsParams.pricesetNprice, 2, 1) || 0 }}{{ toFix(goodsParams.pricesetNprice, 2, 2) || 0 }}
										</view>
										<view class="obottom">
											{{ '￥' + toFix(goodsParams.pricesetMakeprice, 2, 1) || 0 }}{{ toFix(goodsParams.pricesetMakeprice, 2, 2) || 0 }}
										</view>
									</view>
									<view class="right">{{ orderNum }}人已买</view>
								</view>
								<view class="stime">
									<view class="ttop">距结束仅剩：</view>
									<view class="tbottom">
										<u-count-down :timestamp="time" color="#fff" separator-color="#EB2B27"
											font-size="20" bg-color="#EB2B27"></u-count-down>
									</view>
								</view>
							</view>

							<!-- 常规商品 -->
							<view class="detail--warp--goods--explain--top" v-else>
								<view class="detail--warp--goods--explain--top--left">
									...
									<!-- &&goodsParams.goodsType!='40' -->
									<view class="detail--warp--goods--explain--top--left--three u-skeleton-rect"
										v-show="goodsData.pricesetMakeshow != '0'&&goodsParams.pricesetMakeprice!=0">
								...
								<view class="detail--warp--goods--explain--top--right">
									{{ goodsParams.goodsOrdnum || 0 }}人已买</view>
							</view>

							<view class="detail--warp--goods--explain--bottom">
								<view class="gname u-skeleton-rect">
									<vop-label :goodsType="goodsParams.goodsType"></vop-label>
									{{ goodsParams.goodsName || '' }}
								</view>
								<view class="gxing u-skeleton-rect">
									<text class="iconfont icon-xing1"
										v-if="collection.dataObj && collection.success == true"
										@click="cancelCollection"></text>
									<text class="iconfont icon-chakantiezigengduoshoucang" v-else
										@click="addCollection"></text>
								</view>
							</view>
							<view class="detail--warp--goods--explain--bottomFu u-skeleton-rect">
								{{ goodsProperty || '' }}
							</view>
						</view>

						<view class="detail--warp--goods--param">
							<view class="detail--warp--goods--param--discount" v-if="activityList.length > 0"
								@click="discountShow1">
								<view class="detail--warp--goods--param--discount--left u-skeleton-rect">活动</view>
								<view class="detail--warp--goods--param--discount--center u-skeleton-rect">
									<view class="detail--warp--goods--param--discount--center--top u-skeleton-rect">
										<view class="detail--warp--goods--param--discount--center--top--one">
											{{ activityList[0].pbName }}
										</view>
										<view class="detail--warp--goods--param--discount--center--top--two">
											{{ activityList[0].promotionName }}
										</view>
									</view>
									<view class="detail--warp--goods--param--discount--center--bottom u-skeleton-rect"
										v-if="activityList[1]" style="margin-top: 36rpx;">
										<view class="detail--warp--goods--param--discount--center--bottom--one">
											{{ activityList[1].pbName }}
										</view>
										<view class="detail--warp--goods--param--discount--center--bottom--two">
											{{ activityList[1].promotionName }}
										</view>
									</view>
								</view>
								<view class="detail--warp--goods--param--discount--right u-skeleton-rect">
							...
							<view class="detail--warp--goods--param--welfare" @click="welfareShow1">
								<view class="detail--warp--goods--param--welfare--left u-skeleton-rect">优惠</view>
								<view class="detail--warp--goods--param--welfare--center u-skeleton-rect">领取优惠券</view>
								<view class="detail--warp--goods--param--welfare--right u-skeleton-rect">
							...
							<view class="detail--warp--goods--param--norms" @click="normsShow1">
								...
								<view class="detail--warp--goods--param--norms--center u-skeleton-rect">
									{{ goodsData.rsSkuDomainList[specIndex].skuName || '未选择' }}，{{ startNum || 0 }}
									{{ goodsParams.partsnameNumunit || '个' }}
								</view>
								<view class="u-skeleton-rect detail--warp--goods--param--norms--right"
									style="height: 32rpx;">
							...
							<view class="detail--warp--goods--param--address" @click="addressShow1">
								...
								<view class="detail--warp--goods--param--address--center">
									<view class="detail--warp--goods--param--address--center--top u-skeleton-rect">
										{{ addressValue }}
									</view>
						...
						<!-- <view class="detail--warp--goods--shop">
						<view class="detail--warp--goods--shop--introduce" @click="goShop">
							<view class="detail--warp--goods--shop--introduce--left"><image :src="checkImgUrl(shopName.shopdeLogo)"></image></view>
							<view class="detail--warp--goods--shop--introduce--center">
								<view class="detail--warp--goods--shop--introduce--center--one">{{ shopName.shopdeName }}</view>
								<view class="detail--warp--goods--shop--introduce--center--two">自营</view>
							</view>
							<view class="detail--warp--goods--shop--introduce--right">
								<text class="iconfont icon-xiangyou"></text>
							</view>
						</view>
		
						<view class="detail--warp--goods--shop--exhibition">
							<view class="detail--warp--goods--shop--exhibition--left" v-for="(item, index) in storeShow" :key="index">
								<view class="detail--warp--goods--shop--exhibition--left--top"><image :src="checkImgUrl(item.dataPic) " @click="goToDetail(item)"></image></view>
								<view class="detail--warp--goods--shop--exhibition--left--bottom">{{ item.goodsName }}</view>
							</view>
						</view>
					</view> -->
					</view>
						...
						<view class="detail--warp--evaluate--content">
							<view class="detail--warp--evaluate--content--all">
								...
								<view class="detail--warp--evaluate--content--all--right u-skeleton-rect">
									<view class="detail--warp--evaluate--content--all--right--one"
										@click="goEvalueList">全部
									</view>
								...
								<view class="detail--warp--evaluate--content--detailed" v-if="item.evaluateGoodsShow">
									<view class="detail--warp--evaluate--content--detailed--nickname">
										<view class="detail--warp--evaluate--content--detailed--nickname--portrait">
											<image class="u-skeleton-circle" :src="checkImgUrl(item.userImgurl)" mode=""
												style="width: 100%;height: 100%;"></image>
										</view>
										<view class="detail--warp--evaluate--content--detailed--nickname--name">
											<view
												class="detail--warp--evaluate--content--detailed--nickname--name--top u-skeleton-rect">
												{{ item.memberBname }}
											</view>
											<view class="p_list u-skeleton-fillet" v-if="item.evaluateAddImg1 == 0">
												<view class="active_item">好评</view>
											</view>
											<view class="p_list u-skeleton-fillet" v-if="item.evaluateAddImg1 == 1">
												<view class="active_item">中评</view>
											</view>
											<view class="p_list u-skeleton-fillet" v-if="item.evaluateAddImg1 == 2">
												<view class="active_item">差评</view>
											</view>
										</view>
										<view
											class="detail--warp--evaluate--content--detailed--nickname--time u-skeleton-rect">
											{{ handleTime(item.gmtCreate, 'YYYY-MM-DD') }}
										</view>
									</view>
									<view class="detail--warp--evaluate--content--detailed--comment u-skeleton-rect">
										{{ item.evaluateGoodsContent }}
									</view>
									<view class="detail--warp--evaluate--content--detailed--picture"
										v-if="item.evaluateGoodsImgsList">
										<view class="detail--warp--evaluate--content--detailed--picture--item"
											v-for="(item1, index1) in item.evaluateGoodsImgsList" :key="index1">
											<image class="u-skeleton-fillet" :src="checkImgUrl(item1)"
												@click="preview(checkImgUrl(item1),item.evaluateGoodsImgsList)"
												v-if="item1 && item1 != 'null'"></image>
										</view>
									</view>
								</view>
							</view>
							<view class="detail--warp--evaluate--content--more u-skeleton-fillet" @click="goEvalueList">
								查看更多评价</view>
						</view>
					</view>
					<!-- 商品详情 -->
				...
				<view class="detail--purchase">
					<view class="detail--purchase--warp">
						...
						<view class="detail--purchase--warp--car" @click="goCar" v-if="goodsData.goodsType != '26'">
						...
						<view class="detail--purchase--warp--btn2" style="margin-right: 8rpx;"
							:style="{ flex: goodsData.goodsType == '26' ? '1' : '' }">
							<view class="detail--purchase--warp--btn1--shopping" @click="normsShow1"
								:style="{ width: goodsData.goodsType == '26' ? '100%' : '208rpx' }">立即购买</view>
						</view>
				...
				<view class="detail--kefuShow">
					<view>
						...
						<u-modal v-model="kefuShow" :content="Number(content)!=NaN?'客服热线：'+content:content" title='联系客服'
							:show-cancel-button='true' :show-confirm-button="Number(content)!=NaN?true:false"
							confirm-text='呼叫' confirm-color='#ED4444'
							:cancel-color="Number(content)!=NaN?'#888E9B':'#ED4444'" :title-style="{fontWeight: 'bold'}"
							@confirm='openkefu'>
						</u-modal>
					</view>
			...
			<!-- 失效缺省页 -->
			<view v-if="!isShow" class="invalid">
				<image src="https://qjstatic.oss-cn-shanghai.aliyuncs.com/SZRC/shixiao%402x.png" mode=""></image>
				<text class="invalid--text">该商品已失效</text>
				<text class="invalid--btn" @click="goIndex">返回首页</text>
			</view>

			<!-- 活动弹出框 -->
			<view class="detail--discountPopup">
				<u-popup v-model="discountShow" mode="bottom" width="100%" height="966rpx" border-radius="24"
					:closeable="true">
					<view class="detail--discountPopup--main">
						<view class="detail--discountPopup--main--title">活动</view>

						<view class="detail--discountPopup--main--item" v-for="(item, index) in activityList"
							:key="index">
							...
							<view class="detail--discountPopup--main--item--bottom">
								...
								<view class="detail--discountPopup--main--item--bottom--right">{{ item.promotionName }}
								</view>
							</view>
						</view>
					</view>
			...
			<view class="detail--welfarePopup">
				<u-popup v-model="welfareShow" mode="bottom" width="100%" height="966rpx" border-radius="24"
					:closeable="true">
					<view class="detail--welfarePopup--main">
						...
						<view class="detail--welfarePopup--main--receive" v-if="discountList.length > 0">
							...
							<view class="detail--welfarePopup--main--receive--item"
								v-for="(item, index) in discountList" :key="index" v-show="item.availabledate == 0">
										...
										<view>
											...
											<view class="ticketRight">
												...
												<view class="ticketControl">
													<view>
														{{ timesSeconds(item.receiveStart) }}至{{ timesSeconds(item.receiveEnd) }}
													</view>
													<image src="../../static/car/ticketButton.png" mode="widthFix">
													</image>
						...
						<view class="detail--welfarePopup--main--error" v-else>
							<image src="https://qjstatic.oss-cn-shanghai.aliyuncs.com/zhongqing/shenheshibai.png">
							</image>
						</view>
			...
			<view class="detail--normsPopup">
				<u-popup v-model="normsShow" mode="bottom" width="100%" height="966rpx" border-radius="24"
					:closeable="true">
					<view class="detail--normsPopup--main">
						<view class="detail--normsPopup--main--param">
							...
							<view class="detail--normsPopup--main--param--right" v-if="goodsData.rsSkuDomainList">
								<view class="detail--normsPopup--main--param--right--one">
									...
									<!-- &&goodsParams.goodsType!='40' -->
									<view class="detail--normsPopup--main--param--right--one--right"
										v-show="goodsData.rsSkuDomainList[specIndex].pricesetMakeprice != 0&&goodsData.pricesetMakeshow != '0'">
										<span style="font-size: 26rpx;">￥</span>
								...
								<view class="detail--normsPopup--main--param--right--three">
									已选：{{ goodsData.rsSkuDomainList[specIndex].skuName }}，{{ startNum }}
									{{ goodsParams.partsnameNumunit || '个' }}
								</view>
								<view class="detail--normsPopup--main--param--right--four">
									编号：{{ goodsData.rsSkuDomainList[specIndex].skuNo }}</view>
							</view>
						</view>

						<view v-if="goodsData.goodsType != '26'">
							<view class="detail--normsPopup--main--model" v-for="(item, index) in specValueList"
								:key="index">
						...
						<view class="" v-else>
							<view class="detail--normsPopup--main--model">
								<!-- <view class="detail--normsPopup--main--model--top">{{ item.specName }}</view> -->
								<view class="detail--normsPopup--main--model--bottom">
									<view :class="['detail--normsPopup--main--model--bottom--item', 'active']">
						...
						<view class="detail--normsPopup--main--num">
							...
							<view class="detail--normsPopup--main--num--bottom">
								<view class="detail--normsPopup--main--num--bottom--edit">
									<view class="detail--normsPopup--main--num--bottom--edit--left" @click="reduce"
										style="color: #333;">-</view>
									<view class="detail--normsPopup--main--num--bottom--edit--center">{{ startNum }}
									</view>
									<view class="detail--normsPopup--main--num--bottom--edit--right" @click="plus">+
									</view>
								</view>
								<view class="detail--normsPopup--main--num--bottom--start">
									起订量:{{ goodsData.goodsMinnum || 1 }}/{{ goodsParams.partsnameNumunit || '个' }}
								</view>
								<view class="detail--normsPopup--main--num--bottom--end">
									库存:{{ ['24', '26'].includes(goodsParams.goodsType)?stock:goodsParams.goodsSupplynum }}
								</view>
							</view>
						</view>
					</view>
					...
					<view class="detail--normsPopup--shop">
						<view v-if="isHave" style="display: flex;justify-content: space-between;">
							<view class="detail--normsPopup--shop--car" @click="addCart"
								v-if="goodsData.goodsType != '26'">加入购物车</view>
							<view class="detail--normsPopup--shop--shopping" @click="shopping"
								:style="{ width: goodsData.goodsType == '26' ? '100%' : '335rpx' }">立即购买</view>
						</view>
			...
			<view class="detail--addressPopup">
				<u-popup v-model="addressShow" mode="bottom" width="100%" height="966rpx" border-radius="24"
					:closeable="true">
					...
					<scroll-view scroll-y class="detail--addressPopup--main">
						<u-radio-group v-model="addressValue" wrap="true" active-color="red" @change="radioGroupChange">
							<u-radio label-size="28" v-for="(item, index) in addressList" :key="index"
	...
	export default {
		...
		onShow() {
			...
			http.get(detail.goodsDetail, {
				...
				if (res.rsGoodsFileDomainList.length > 0) {
				...
				this.goodsProperty = res.goodsProperty;
				...
				if (res.goodsType == 26) {
					http.post(myOrder.getStockBypromotionCode, {
						promotionCode: res.ginfoCode
					}).then(res => {
						this.orderNum = res.dataObj.memNum;
						this.stock = res.dataObj.stock;
					});
				}
			});
		},
		...
		onShareAppMessage() {
			...
			return {
				title: '千匠星云',
				path: "/pages/detail/main?skuNo=" + skuCode + "&memberDiscode=" + memberDiscode + "&time=" + time +
					"&promotionCode=" + promotionCode + "&promotionFrequency=" + promotionFrequency,
			};
		},
		...
		methods: {
			...
			getGoodsOfActivity(res) {
				...
				console.log(skuBeanStr, "营销活动")

				http.get(detail.goodsOfActivity, {
					skuBeanStr: JSON.stringify(skuBeanStr)
				}).then(res => {
					// console.log(res);
			...
			getGoodsOfEvaluate(res) {
				console.log(res, 'getGoodsOfEvaluate')
				http.get(detail.evaluateDetail, {
					goodsCode: res.goodsCode
				}).then(res => {
					console.log(res, '=================');
					res.list.map(v => {
						v.memberBname = v.memberBname.substring(0, 1) + '***' + v.memberBname.substring(v
							.memberBname.length - 1);
					});
			...
			scrollChange(e) {
				...
				if (e.detail.scrollTop > this.box1Height + this.box2Height && e.detail.scrollTop < this.box1Height + this
					.box2Height + this.box3Height) {
					console.log('详情高亮');
					this.viewBox = '';
					this.goodsShow = false;
					this.evaluateShow = false;
			...
			//点击数量增加
			plus() {
				if (this.startNum >= this.goodsParams.goodsNum || this.startNum == this.goodsParams.goodsSupplynum || this
					.startNum >= this.goodsStockNum) {
					this.$message.alert('库存不足')
					return;
				}
				let num = this.startNum + 1;
				console.log(this.goodsData.goodsType, "this.goodsData.goodsType")
				if ((this.goodsData.goodsType == '26' || this.goodsData.goodsType == '24') && this.promotionFrequency >
					0) {
			...
			//规格弹窗
			normsShow1() {
				if (this.goodsData.isCardUser) {
					this.$message.alert('卡券用户或游客，不能购买商品！')
					return;
				}
				this.normsShow = true;
				this.changeSku();
			...
			async addCart() {
				...
				if (beforePage.route == 'pages/index/main') {
					// #endif
					// #ifdef H5
					var pages = this.$storage.get('olUrl');
					var beforePage = pages[pages.length - 1];
					if (beforePage.olUrl == 'pages/index/main') {
						// #endif
						...
						if (res && res.list.length > 0) {
							res.list = res.list.filter(item => item.goodsType !== '26' && item.goodsType !== '24');
						}
						if (res && res.list.length > 0) {
							// res=res.list.filter(item=>(item.goodsType!=="26"&&item.goodsType!=="24"))
							console.log(res, 'res');
				...
				//商品详情页直接购买
				shopping() {
						if (this.goodsData.goodsType == 'jd' || this.goodsData.rsSkuDomainList[this.specIndex]
							.dataOpbillstate == 0) {
							this.$message.alert('该商品已下架')
							return
						}
						if (this.goodsData.goodsType == '24' || this.goodsData.goodsType == '26') {
							let params = {
								promotionCode: this.goodsData.ginfoCode,
								num: this.startNum,
								skuNo: this.skuCode
							}
							http.get(checkSecondKillNum, params).then(response => {
								if (!response.success) {
					...
					cancelCollection() {
						http.post(detail.cancelCollection, {
							collectType: 0,
							collectCode: this.collection.dataObj
						}).then(res => {
							this.collection = res;
						});
						//取消收藏的数据收集
					...
					goShop() {
						this.$routers.push('myStore/index', {
							memberCode: this.goodsData.memberCode
						})
					},
					...
					//跳转到评价页面
					goEvalueList() {
						this.$routers.push('evaluate_modules/goodsEvaluates', {
							goodsCode: this.goodsData.goodsCode
						})
					}
			}
